...
export const DEFAULT_THESES: ThesisWithRelations[] = [
  {
    ...
    college_id: COLLEGE_OF_SCIENCES_ID,
    program_id: 'b3000000-0000-0000-0000-000000000003', // BS Computer Science
    panel_score: 95.5,
    pdf_file: '',
    view_count: 142,
    ss_paper_id: null,
  ...
  },
  {
    ...
    uploaded_by: '00000000-0000-0000-0000-000000000000',
    college_id: COLLEGE_OF_SCIENCES_ID,
    program_id: 'b2000000-0000-0000-0000-000000000002', // BS Marine Biology
    panel_score: 93.0,
    pdf_file: '',
    view_count: 98,
    ss_paper_id: null,
  ...
  },
  {
    ...
    uploaded_by: '00000000-0000-0000-0000-000000000000',
    college_id: COLLEGE_OF_SCIENCES_ID,
    program_id: 'b1000000-0000-0000-0000-000000000001', // BS Biology
    panel_score: 91.5,
    pdf_file: '',
    view_count: 85,
    ss_paper_id: null,
  ...
  },
  {
    ...
    uploaded_by: '00000000-0000-0000-0000-000000000000',
    college_id: COLLEGE_OF_SCIENCES_ID,
    program_id: 'b4000000-0000-0000-0000-000000000004', // BS Environmental Science
    panel_score: 89.0,
    pdf_file: '',
    view_count: 73,
    ss_paper_id: null,
  ...
  },
  {
    ...
    uploaded_by: '00000000-0000-0000-0000-000000000000',
    college_id: COLLEGE_OF_SCIENCES_ID,
    program_id: 'b5000000-0000-0000-0000-000000000005', // BS Information Technology
    panel_score: 96.0,
    pdf_file: '',
    view_count: 165,
    ss_paper_id: null,
